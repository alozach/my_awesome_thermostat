"""Adds support for my awesome thermostat units."""
import asyncio
import logging
import math
...
DEFAULT_NAME = "My Awesome Thermostat"
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    """Set up the My awesome thermostat platform."""
...
class MyAwesomeThermostat(ClimateEntity, RestoreEntity):
    """Representation of a My Awesome Thermostat device."""
    ...
    def __init__(
        ...
        self._cancel_window_listener = None
    ...
    async def _async_windows_changed(self, event):
        ...
        self._cancel_window_listener = async_call_later(self.hass, self.windows_delay, try_window_delay_condition)
        ...
        async with self._temp_lock:
            if not self._active and None not in (
                ...
                _LOGGER.info(
                    ...
                    "My awesome thermostat active. %s, %s",
                    self._cur_temp,
                    self._target_temp,
                )
